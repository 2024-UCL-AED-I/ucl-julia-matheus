...
using static Spider_Man_s_Rogues_Gallery.Classes.Vilao;
...
public class SuperPoder
{
    ...
    public static List<SuperPoder> ExtrairPoderes(string listaBrutaPoderes)
    {
        var poderes = new List<SuperPoder>();

        // Aqui você pode implementar a lógica para extrair os poderes da string e criar objetos SuperPoder
        // Por exemplo, dividindo a string pelos separadores e criando um SuperPoder para cada parte.

        // Exemplo simples:
        string[] poderesSeparados = listaBrutaPoderes.Split(';');
        foreach (string poder in poderesSeparados)
        {
            poderes.Add(new SuperPoder(poder.Trim()));
        }
